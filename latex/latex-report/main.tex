...
\fancypagestyle{firststyle}
{
   ...
   % Link to GitHub
   \faGithub \ 
   \href{https://github.com/nicolossus}{github.com/nicolossus/FYS-STK4155-Project3}}
   \renewcommand{\headrulewidth}{0pt}
   \renewcommand{\footrulewidth}{0.4pt}
}
% rest of document
\fancyhead[L]{\small FYS-STK4155}        % Set <course>
\fancyhead[C]{\small Project 3}          % Set <title>    
\fancyhead[R]{\small December 15, 2019}  % Set <date>
\fancyfoot[C]{-- \thepage\ --}
