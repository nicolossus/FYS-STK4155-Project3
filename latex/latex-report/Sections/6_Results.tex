...
\begin{figure}[H]
\centering
\subfloat[]{{\includegraphics[scale=0.6]{latex/figures/eigval_run66a.pdf}}}
\qquad
\subfloat[]{{\includegraphics[scale=0.6]{latex/figures/eigval_run66b.pdf}}}
\qquad
\subfloat[]{{\includegraphics[scale=0.6]{latex/figures/eigval_run66c.pdf}}}
\qquad
\subfloat[]{{\includegraphics[scale=0.6]{latex/figures/eigval_run66d.pdf}}}
